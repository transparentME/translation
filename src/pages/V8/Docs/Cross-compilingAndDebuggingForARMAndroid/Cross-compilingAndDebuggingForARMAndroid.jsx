...
运行gclient sync，然后你将会在./third_party/android_tools下看到一个大的checkout。
Enable developer mode on your phone or tablet, and turn on USB debugging, via instructions here.
Also, get the handy adb tool on your path.
It’s in your checkout at ./third_party/android_sdk/public/platform-tools.
